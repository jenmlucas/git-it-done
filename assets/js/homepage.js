//to store reference to the form elment
...
var formSubmitHandler = function (event) {
    //stops browser from performing the default action the event wants to do. In this case stops it from sending the form's input data to a URL
